import { users, type User, type InsertUser, type ZodiacSign, type EarningsResult } from "@shared/schema";
...
export interface IStorage {
  ...
  getAllZodiacSigns(): ZodiacSign[];
  getZodiacBySign(sign: string): ZodiacSign | undefined;
  getZodiacByDate(date: string): ZodiacSign | undefined;
  calculateEarningPotential(birthdate: string, name: string): EarningsResult;
}
